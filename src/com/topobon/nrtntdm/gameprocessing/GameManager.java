...
//				p.setHealth(0);
			...
			//	p.sendMessage(Utility.messageToPlayer("&bJust removing your sins... Unaware to death Nor known to life"));
			//p.setHealth(0);
			}
	...
	public static void selectWinningTeam() {
		...
		if (TeamDeathMatch.getBluePoints() == TeamDeathMatch.getRedPoints() && TeamDeathMatch.isGameRunning()) {
			...
			for (Player p : TeamDeathMatch.getPlayersInRedTeam()) {
				...
				p.sendMessage(Utility.messageToPlayer("&bJust removing your sins... I have forged over thousands of weapons"));
				p.setHealth(0);
			}
		}
